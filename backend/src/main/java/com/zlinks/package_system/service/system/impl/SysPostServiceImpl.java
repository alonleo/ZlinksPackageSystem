...
public Page<SysPost> selectPostPage(Page<SysPost> page, SysPost query) {
        ...
        if (StringUtils.isNotBlank(query.getPostCode())) w.like(SysPost::getPostCode, query.getPostCode());
        if (StringUtils.isNotBlank(query.getPostName())) w.like(SysPost::getPostName, query.getPostName());
        if (StringUtils.isNotBlank(query.getStatus())) w.eq(SysPost::getStatus, query.getStatus());
