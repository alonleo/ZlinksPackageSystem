...
namespace ZlinksPackageSystem.Desktop.Views
{
    public partial class SettingsView : UserControl
    {
        ...
        private void FontSizePreset_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
        ...
        private void ApplyCustomFont_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
        ...
        // 移除按钮:调用 VM 的删除命令
        private void RemoveCustomFont_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
            if (sender is Button { Tag: CustomFontInfo info } && DataContext is SettingsViewModel vm)
            {
