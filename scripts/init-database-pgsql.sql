...
CREATE TABLE IF NOT EXISTS tool (
    ...
    create_venv             SMALLINT DEFAULT 0,
...
-- PG 风格: BIGINT GENERATED BY DEFAULT AS IDENTITY
-- ============================================================
...
COMMENT ON TABLE task IS '任务分配主表(target_type=product/game/test)';
...
COMMENT ON TABLE notification_recipient IS '通知收件箱';
...
COMMENT ON TABLE assignment_event IS '任务状态变更事件流(append-only)';
...
COMMENT ON TABLE assignment_history IS '管理员操作审计快照';

-- ============================================================
-- F1 修复: 补全 PG/MySQL 缺失的 sys_job / sys_job_log (H2 已有)
-- ============================================================
